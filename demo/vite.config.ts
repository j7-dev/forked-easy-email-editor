...
export default defineConfig({
  ...
  resolve: {
    alias: {
      'j7-easy-email-editor/lib/style.css': path.resolve(__dirname, 'package.json'), // 没有用的，只是防止css 404报错
      'j7-easy-email-extensions/lib/style.css': path.resolve(__dirname, 'package.json'), // 没有用的，只是防止css 404报错
      ...
      'j7-easy-email-core': path.resolve('../packages/easy-email-core/src/index.tsx'),
      'j7-easy-email-editor/lib/locales.json': path.resolve(
        '../packages/easy-email-editor/public/locales.json',
      ),
      'j7-easy-email-localization': path.resolve('../packages/easy-email-localization'),
      'j7-easy-email-editor': path.resolve('../packages/easy-email-editor/src/index.tsx'),
      'j7-easy-email-extensions': path.resolve(
